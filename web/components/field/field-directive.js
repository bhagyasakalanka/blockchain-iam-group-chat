        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                scope.getDataUrl = function() {
                    ...
                    if (decodedString.includes('PRIVATE KEY')) {
                        document.getElementById("privateKey").value = decodedString;
                        document.getElementById("privateKey").innerHTML = decodedString;
                    } else {
                        document.getElementById("pkText").value = decodedString;

                        //$('#publickey').val(decodedString);
                        document.getElementById("publickey").value = decodedString;
                        document.getElementById("publickey").innerHTML = decodedString;
                    }
                    storeKeys();
